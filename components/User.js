...
const User = ({user, deleteUser}) => {
  ...
  return (
    ...
    <td className='text-right px-6 py-4 whitespace-nowrap'>
        ...
        href="#" className='text-indigo-600 hover:text-indigo-800 hover:cursor-pointer px-4'>
            Edit
            </a>
        <a 
        onClick={(e,id)=> deleteUser(e,user.id)}
        href="#" className='text-indigo-600 hover:text-indigo-800 hover:cursor-pointer'>
            Delete
            </a>
    </td> 
</tr>
